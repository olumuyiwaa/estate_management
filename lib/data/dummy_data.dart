...
class DummyData {
  ...
  static final List<Incident> incidents = [
    ...
    Incident(id: 'i6', reportedBy: 'Adaeze Okonkwo', title: 'Unauthorized Parking at Resident Lot', description: 'A delivery van has been parked in the resident-only parking bay outside A-101 for the past 2 hours.', location: 'Resident Parking Lot', status: IncidentStatus.open, priority: TicketPriority.medium, reportedAt: DateTime(2026, 4, 11)),
    Incident(id: 'i7', reportedBy: 'Adaeze Okonkwo', title: 'Broken Access Gate Sensor', description: 'The access gate sensor failed to register entry for two vehicles after 7 PM yesterday.', location: 'Main Gate', status: IncidentStatus.inProgress, priority: TicketPriority.high, reportedAt: DateTime(2026, 4, 12), assignedTo: 'Amaka Nwosu'),
    Incident(id: 'i8', reportedBy: 'Adaeze Okonkwo', title: 'Overflowing Drain Near Block A', description: 'Water is overflowing from the drainage near Block A after the recent rain, creating a slippery path for residents.', location: 'Block A Perimeter', status: IncidentStatus.open, priority: TicketPriority.urgent, reportedAt: DateTime(2026, 4, 13)),
    Incident(id: 'i9', reportedBy: 'Adaeze Okonkwo', title: 'Unauthorized Vendor Stall in Walkway', description: 'A vendor stall has been set up in the pedestrian walkway leading to A-101, obstructing safe passage.', location: 'Block A Walkway', status: IncidentStatus.open, priority: TicketPriority.medium, reportedAt: DateTime(2026, 4, 14)),
    Incident(id: 'i10', reportedBy: 'Adaeze Okonkwo', title: 'Garden Sprinkler Malfunction', description: 'The sprinkler near the A-101 garden has been spraying water onto the sidewalk for over an hour.', location: 'A-101 Garden', status: IncidentStatus.inProgress, priority: TicketPriority.low, reportedAt: DateTime(2026, 4, 14)),
    Incident(id: 'i11', reportedBy: 'Adaeze Okonkwo', title: 'Street Sign Missing at Corner', description: 'The street name sign at the corner of A-101 and A-102 is missing, making navigation difficult for visitors.', location: 'Corner of A-101/A-102', status: IncidentStatus.open, priority: TicketPriority.medium, reportedAt: DateTime(2026, 4, 15)),
    Incident(id: 'i12', reportedBy: 'Adaeze Okonkwo', title: 'Package Theft Suspicion', description: 'A resident reported a package missing from the compound and the gate camera recorded an unknown visitor nearby.', location: 'A-101 Compound', status: IncidentStatus.inProgress, priority: TicketPriority.high, reportedAt: DateTime(2026, 4, 15), assignedTo: 'Amaka Nwosu'),
    Incident(id: 'i13', reportedBy: 'Adaeze Okonkwo', title: 'Loud Music After Quiet Hours', description: 'Loud music was heard from the clubhouse area after 11 PM, disturbing nearby residents.', location: 'Clubhouse', status: IncidentStatus.open, priority: TicketPriority.medium, reportedAt: DateTime(2026, 4, 16)),
